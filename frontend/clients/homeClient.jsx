                  ...
                  <div className = "px-4 py-3 w-72">
                    ...
                    <div className='flex justify-left gap-x-4'>
                        <Link to={`/items/show/${item._id}`}>
                          <BsInfoCircle className = 'text-2x1 text-green-800 duration-500 hover:scale-105 hover:shadow-xl'/>
                        </Link>
                        <Link to={`/items/edit/${item._id}`}>
                          <AiOutlineEdit className = 'text-2x1 text-yellow-600 duration-500 hover:scale-105 hover:shadow-xl'/>
                        </Link>
                        <Link to={`/items/delete/${item._id}`}>
                          <MdOutlineDelete className = 'text-2x1 text-red-600 duration-500 hover:scale-105 hover:shadow-xl'/>
                        </Link>
                      </div>
                  </div>
                </div>
